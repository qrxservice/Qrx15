...
export const GetAppSettingsResponse = zod.object({
  ...
  "doctorTemplateManagementEnabled": zod.boolean().optional()
})
...
export const RequestUploadUrlBody = zod.object({
  ...
  "category": zod.enum(['doctors', 'prescriptions', 'chat', 'banners', 'blog', 'shop', 'general']).optional().describe('Upload category — determines the storage subdirectory. Defaults to "general".')
})
...
// ─── Network: Cancel Friend Request ───────────────────────────────────────
export const CancelFriendRequestResponse = zod.object({})

// ─── Network: Stats Dashboard ─────────────────────────────────────────────
export const NetworkStatsResponse = zod.object({
  "totalConnections": zod.number(),
  "pendingRequestsReceived": zod.number(),
  "pendingRequestsSent": zod.number(),
  "referralsSent": zod.number(),
  "referralsReceived": zod.number(),
  "consultationsSent": zod.number(),
  "consultationsPending": zod.number(),
  "unreadMessages": zod.number()
})

// ─── Patient Referrals ────────────────────────────────────────────────────
export const PatientReferralItem = zod.object({
  "id": zod.number(),
  "referrerDoctorId": zod.number(),
  "receiverDoctorId": zod.number(),
  "patientName": zod.string(),
  "patientPhone": zod.string().nullish(),
  "patientAge": zod.number().nullish(),
...
export const ReferralsListResponse = zod.object({
  "sent": zod.array(PatientReferralItem),
  "received": zod.array(PatientReferralItem)
})
...
export const DoctorConsultationItem = zod.object({
  "id": zod.number(),
  "requesterDoctorId": zod.number(),
  "consultantDoctorId": zod.number(),
  "patientInfo": zod.string().nullish(),
  "caseNotes": zod.string(),
  "attachmentUrl": zod.string().nullish(),
  "attachmentType": zod.string().nullish(),
  "attachmentName": zod.string().nullish(),
  "attachmentSize": zod.number().nullish(),
...
export const ConsultationsListResponse = zod.object({
  "sent": zod.array(DoctorConsultationItem),
  "received": zod.array(DoctorConsultationItem)
})

export const CreateConsultationBody = zod.object({
  "consultantDoctorId": zod.number(),
  "patientInfo": zod.string().optional(),
  "caseNotes": zod.string(),
  "attachmentUrl": zod.string().nullish(),
  "attachmentType": zod.string().nullish(),
  "attachmentName": zod.string().nullish(),
...
export const UpdateConsultationBody = zod.object({
  "responseNotes": zod.string().optional(),
  "status": zod.string().optional()
})
